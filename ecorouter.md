...
ip nat outside
exit
ip nat pool VL100 192.168.100.1-192.168.100.62
ip nat pool VL200 192.168.200.1-192.168.200.14
ip nat pool VL999 192.168.9.1-192.168.9.6
...
conf t
ip pool VL200 192.168.200.1-192.168.200.14
dhcp-server 200
mask 28
pool VL200 1
mask 28
...
ntp server 172.16.4.14
ntp timezone utc+3
do wr
do sh ntp status (вывод: 172.16.4.14)
